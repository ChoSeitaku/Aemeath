// Yoga adapter for standard yoga-layout npm package
// Replaces Claude Code's custom TS yoga port with the standard npm package
...
export class YogaLayoutNode implements LayoutNode {
  ...
  setMeasureFunc(fn: LayoutMeasureFunc): void {
    this.yoga.setMeasureFunc((w: number, wMode: MeasureMode) => {
      const mode =
